    ...
    const network = new vis.Network(container);
            ...
            function createData() {
              if (user === "0") {
                ...
                // Adding bus(#21209c) edges in edges[]
                ...
                // Adding plane(#54e346) edges in edges[]
            ...
            function solveData() {
              ...
              let {
                ...
                p1,
                p2
              } = shouldTakePlane(data['edges'], dist1, dist2, mn_dist);
